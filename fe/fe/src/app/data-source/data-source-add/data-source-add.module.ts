...
// import { DataSourceAddRoutingModule } from './data-source-add-routing.module';
...
@NgModule({
  imports: [
    CommonModule,
    // DataSourceAddRoutingModule, // Needs only for #LazyLoading
...
export class DataSourceAddModule { }
